...
async function main() {
  ...
  const facilities = [
    ...
    { id: "MBIBG-26070003", name: "Issuer 1932340 Invoice Note 3", group: "Invoice Financing", type: "Invoice Financing", tier: "B+", rate: 7, tenor: 540, min: 100, max: 5000, progress: 100, amount: 500000, service: 8, issuer: "Issuer ID - 1932340", status: "Ongoing", campaignStart: "2026-07-01", campaignEnd: "2026-07-08" },
    ...
    { id: "IIF2101-15082026", name: "Boutique Builders 12", group: "Working Capital", type: "Working Capital", tier: "B", rate: 9, tenor: 60, min: 100, max: 8000, progress: 20, amount: 60000, service: 6, issuer: "Boutique Builders Sdn Bhd", status: "Open", campaignStart: "2026-08-15", campaignEnd: "2026-08-22" },
    ...
    { id: "IIF2103-15082026", name: "Green Energy Solutions 4", group: "Contract Financing", type: "Contract Financing", tier: "B+", rate: 7.5, tenor: 120, min: 100, max: 10000, progress: 10, amount: 180000, service: 7, issuer: "Green Energy Solutions MY", status: "Open", campaignStart: "2026-08-16", campaignEnd: "2026-08-23" },
    { id: "IIF2104-15082026", name: "Urban Logistics 7", group: "Working Capital", type: "Working Capital", tier: "C+", rate: 9.5, tenor: 45, min: 100, max: 6000, progress: 0, amount: 45000, service: 8, issuer: "Urban Logistics Sdn Bhd", status: "Open", campaignStart: "2026-08-17", campaignEnd: "2026-08-24" },
    ...
    { id: "IIF2106-15082026", name: "Digital Marketing Hub 2", group: "Contract Financing", type: "Contract Financing", tier: "B", rate: 8, tenor: 75, min: 100, max: 7000, progress: 30, amount: 70000, service: 6, issuer: "Digital Marketing Hub", status: "Open", campaignStart: "2026-08-12", campaignEnd: "2026-08-19" },
    { id: "IIF2107-15082026", name: "Precision Engineering Works 6", group: "Working Capital", type: "Working Capital", tier: "B+", rate: 7, tenor: 150, min: 100, max: 12000, progress: 15, amount: 220000, service: 7, issuer: "Precision Engineering Works", status: "Open", campaignStart: "2026-08-18", campaignEnd: "2026-08-25" },
    ...
    { id: "IIF2109-15082026", name: "EcoPackaging Industries 1", group: "Contract Financing", type: "Contract Financing", tier: "C+", rate: 10, tenor: 90, min: 100, max: 8000, progress: 5, amount: 95000, service: 9, issuer: "EcoPackaging Industries", status: "Open", campaignStart: "2026-08-19", campaignEnd: "2026-08-26" },
    { id: "IIF2110-15082026", name: "Metro Retail Chain 8", group: "Working Capital", type: "Working Capital", tier: "B", rate: 8.2, tenor: 40, min: 100, max: 6500, progress: 25, amount: 65000, service: 6, issuer: "Metro Retail Chain Sdn Bhd", status: "Open", campaignStart: "2026-08-10", campaignEnd: "2026-08-17" },
  ];
  for (const f of facilities) {
    statements.push(
      `INSERT INTO financing_facilities (id, issuer_user_id, product_group, financing_type, risk_tier, rate_pct, tenor_days, days_elapsed, min_investment, max_investment, funding_progress_pct, principal_amount, service_fee_pct, issuer_name, status, first_payment_date, last_payment_date, note_name, campaign_start, campaign_end, created_at) VALUES (${sqlStr(f.id)}, ${sqlStr(f.issuerUserId ?? null)}, ${sqlStr(f.group)}, ${sqlStr(f.type)}, ${sqlStr(f.tier)}, ${sqlNum(f.rate)}, ${sqlNum(f.tenor)}, 0, ${sqlNum(f.min)}, ${sqlNum(f.max)}, ${sqlNum(f.progress)}, ${sqlNum(f.amount)}, ${sqlNum(f.service)}, ${sqlStr(f.issuer)}, ${sqlStr(f.status)}, ${sqlStr(f.first ?? null)}, ${sqlStr(f.last ?? null)}, ${sqlStr(f.name)}, ${sqlStr(f.campaignStart)}, ${sqlStr(f.campaignEnd)}, ${sqlTs(now)});`
    );
  }
