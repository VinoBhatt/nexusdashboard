...
function makeFacility(overrides: Partial<Parameters<typeof matchesRule>[1]> = {}) {
  return {
    ...
    campaignApplicationDate: null,
    campaignApprovalDate: null,
    campaignUrl: null,
    campaignSector: null,
    sustainabilityCategory: null,
    typeOfInvestmentNotes: null,
    shariahAdviserName: null,
    purposeOfFundRaising: null,
    purposeOfFundRaisingOther: null,
    remark: null,
    isSaranaScheme: false,
    saranaFinancingOptions: null,
    saranaFinancingScope: null,
    targetFinancingAmount: null,
    financingSecurity: null,
    issuerInterestRateEffective: null,
    investorReturnRateSimple: null,
    investorReturnRateEffective: null,
    defaultClassification: null,
    defaultClassificationOther: null,
    actualDueRepaymentDate: null,
    mycifSchemeType: null,
    mycifCoInvestmentAmount: null,
    issuerCurrentRevenueRM: null,
    issuerCurrentCustomerBase: null,
    issuerCurrentEmployeeCount: null,
    mycifProblemStatement: null,
    mycifSolution: null,
    mycifBeneficiaries: null,
    mycifOutcomes: null,
    mycifFundUtilisationPct: null,
    mycifImpactMeasure: null,
    mycifBaseline: null,
    mycifImpactTarget: null,
    mycifProgressPct: null,
    mycifKeyMilestones: null,
    mycifChallenges: null,
    mycifMitigationStrategies: null,
    ...
    delinquentDays: null,
    defaultDays: null,
    facilityPrincipalOutstanding: null,
    createdAt: new Date(),
    ...overrides,
  };
}
